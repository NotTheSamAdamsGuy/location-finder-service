...
export const getNearbyLocations = async (
  data: Record<string, number | "m" | "km" | "ft" | "mi" | "ASC" | "DESC">
) => {
  ...
  try {
    const locations = locationDao.findNearbyByGeoRadius(
      latitude,
      longitude,
      radius,
      unitOfDistance,
    ...
    throw new Error("Encountered error while fetching nearby locations", err);
  }
};
 ...
 */
export const addLocation = async (data: Record<string, string | Express.Multer.File[] | Express.MulterS3.File>) => {
